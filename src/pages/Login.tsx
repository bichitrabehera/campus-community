            ...
            >
              <div>
                ...
                <div className="mt-2">
                  <input
                    required
                    className="block w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-base text-gray-900 shadow-sm outline-1 focus:outline-2 focus:outline-indigo-600 focus:border-indigo-600 placeholder:text-gray-400 sm:text-sm/6"
                    type="email"
                    value={email}
